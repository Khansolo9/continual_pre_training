...
| Artifact | Path |
|----------|------|
| Config | configs/smoke/baseline_smoke.yaml |
| Metrics JSON | experiments/runs/smoke_baseline_s1/metrics.json |
| Domain A Checkpoint | experiments/runs/smoke_baseline_s1/checkpoints/theta_A.pt |
| Final Checkpoint | experiments/runs/smoke_baseline_s1/checkpoints/theta_AB.pt |

---

**Generated**: 2026-02-06T17:10:52.347467
