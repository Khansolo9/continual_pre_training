# Runpack: qwen3_smoke_baseline_s1
...
| Field | Value |
|-------|-------|
| **Run ID** | qwen3_smoke_baseline_s1 |
| **Method** | baseline |
| **Seed** | 1 |
...
| Artifact | Path |
|----------|------|
| Config | experiments/runs/qwen3_smoke_baseline_s1/config_merged.yaml |
| Metrics JSON | experiments/runs/qwen3_smoke_baseline_s1/metrics.json |
| Domain A Checkpoint | experiments/runs/qwen3_smoke_baseline_s1/checkpoints/theta_A.pt |
| Final Checkpoint | experiments/runs/qwen3_smoke_baseline_s1/checkpoints/theta_AB.pt |

---

**Generated**: 2026-02-11T23:24:30.360705
