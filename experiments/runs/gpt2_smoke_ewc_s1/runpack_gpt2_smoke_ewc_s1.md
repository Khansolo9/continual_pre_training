...
| After Domain B (final) | 30.72 | 48.45 |
...
| Metric | Before | After |
|--------|-------:|------:|
| **Drift (JS divergence)** | 0.2153 | 0.1830 |
| Vocab Overlap | 0.3641 | 0.4171 |
...
| Artifact | Path |
|----------|------|
| Config | experiments/runs/gpt2_smoke_ewc_s1/config_merged.yaml |
| Metrics JSON | experiments/runs/gpt2_smoke_ewc_s1/metrics.json |
| Domain A Checkpoint | experiments/runs/gpt2_smoke_ewc_s1/checkpoints/theta_A.pt |
| Final Checkpoint | experiments/runs/gpt2_smoke_ewc_s1/checkpoints/theta_AB.pt |

---

**Generated**: 2026-02-11T23:08:11.106369
